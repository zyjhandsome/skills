...
4. Stage end: emit one complete `delivery-handoff/v1` object (including end states), validate it. If chaining is unsupported, tell the user「请使用 delivery-frame-spec」when a transition is allowed.
