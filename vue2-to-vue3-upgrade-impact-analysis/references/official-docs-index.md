...
| Node release schedule | https://github.com/nodejs/Release/blob/main/schedule.json | At `evidence_as_of`, distinguish Active LTS from Maintenance/EOL before recommending a declaration value; then resolve the chosen line's current exact patch |
