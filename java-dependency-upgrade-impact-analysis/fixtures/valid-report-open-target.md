...
|---|---|---|---|---|---|
| Boot BOM / `snakeyaml.version`（已在 effective POM 核实） | 2.0 | 2.2 | `2-property-override` | https://github.com/advisories/GHSA-mjmj-j48q-9wg2 | 对齐安全基线 |
...
- 版本 2.2 为已验证 GA 推荐，仍须由用户逐单元选择，不自动选定。
